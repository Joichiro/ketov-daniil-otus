export const saveChannel = (rssChannel, channelId, url) => {
...
export const getChannelsList = (rssChannel, cb) => {
  rssChannel
    .find({})
    .lean()
    .then(channels => {
      cb(
        channels.map(channel => {
          return {channelId: channel.channelId, url: channel.url};
        })
      );
    })
    .catch(err => {
...
export const getRssItems = (rssItem, channelId, cb) => {
  rssItem
